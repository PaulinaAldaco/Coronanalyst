...
import { preguntas } from "./inputsEncuesta"
...
function Encuesta() {
    ...
    const isRequired = (e) =>{
        ...
        var pregunta = state[e.target.name]
        const actualState = state;
        var alMenosUno = false;
        checkBox1.required = false;
        for (var element in pregunta){
            if(element.isChecked){
                console.log("Is required: ", false);
                return false
                            ...
                            <div class="radio">
                                <React.Fragment>{
                                    initialState.compras.map(item => (
                                        <label>
                                            <input type="radio" name="compras" value={item.value} onChange={onChangeValue} required />
                                            {item.value}
                                            <br/>
                                        </label>
                                    ))
                            ...
                            <div class="checkbox">
                                <React.Fragment>{
                                    initialState.plataforma.map(item => (
                                        <label>
                                            <input type="checkbox" ref={checkBox1} onClick={isRequired} name="plataforma" value={item.value} onChange={onChange(item)} required={true} />
                                            {item.value}
                                            <br/>
                                        </label>
                                    ))
                            ...
                            <div class="checkbox">
                                <React.Fragment>{
                                    initialState.pago.map(item => (
                                        <label>
                                            <input type="checkbox" name="pago" value={item.value} onChange={onChange(item)} />
                                            {item.value}
                                            <br/>
                                        </label>
                                    ))
                            ...
                            <div class="checkbox">
                                <React.Fragment>{
                                    initialState.categoria.map(item => (
                                        <label>
                                            <input type="checkbox" name="categoria" value={item.value} onChange={onChange(item)} />
                                            {item.value}
                                            <br/>
                                        </label>
                                    ))
                            ...
                            <div class="radio">
                                <React.Fragment>{
                                    initialState.tiempo.map(item => (
                                        <label>
                                            <input type="radio" name="tiempo" value={item.value} onChange={onChangeValue} required />
                                            {item.value}
                                            <br/>
                                        </label>
                                    ))
                            ...
                            <div class="radio">
                                <React.Fragment>{
                                    initialState.seguido.map(item => (
                                        <label>
                                            <input type="radio" name="seguido" value={item.value} onChange={onChangeValue} required />
                                            {item.value}
                                            <br/>
                                        </label>
                                    ))
                            ...
                            <div class="checkbox">
                                <React.Fragment>{
                                    initialState.plataformaPandemia.map(item => (
                                        <label>
                                            <input type="checkbox" name="plataformaPandemia" value={item.value} onChange={onChange(item)} />
                                            {item.value}
                                            <br/>
                                        </label>
                                    ))
                            ...
                            <div class="checkbox">
                                <React.Fragment>{
                                    initialState.metodoPago.map(item => (
                                        <label>
                                            <input type="checkbox" name="metodoPago" value={item.value} onChange={onChange(item)} />
                                            {item.value}
                                            <br/>
                                        </label>
                                    ))
                            ...
                            <div class="checkbox">
                                <React.Fragment>{
                                    initialState.categoriaCompra.map(item => (
                                        <label>
                                            <input type="checkbox" name="categoriaCompra" value={item.value} onChange={onChange(item)} />
                                            {item.value}
                                            <br/>
                                        </label>
                                    ))
                            ...
                            <div class="radio">
                                <React.Fragment>{
                                    initialState.tiempoComputadora.map(item => (
                                        <label>
                                            <input type="radio" name="tiempoComputadora" value={item.value} onChange={onChangeValue} required />
                                            {item.value}
                                            <br/>
                                        </label>
                                    ))
                            ...
                            <div class="radio">
                                <React.Fragment>{
                                    initialState.dineroEnLinea.map(item => (
                                        <label>
                                            <input type="radio" name="dineroEnLinea" value={item.value} onChange={onChangeValue} required />
                                            {item.value}
                                            <br/>
                                        </label>
                                    ))
                            ...
                            <div class="radio">
                                <React.Fragment>{
                                    initialState.fisicoLinea.map(item => (
                                        <label>
                                            <input type="radio" name="fisicoLinea" value={item.value} onChange={onChangeValue} required />
                                            {item.value}
                                            <br/>
                                        </label>
                                    ))
                            ...
                            <div class="radio">
                                <React.Fragment>{
                                    initialState.sintomas.map(item => (
                                        <label>
                                            <input type="radio" name="sintomas" value={item.value} onChange={onChangeValue} required />
                                            {item.value}
                                            <br/>
                                        </label>
                                    ))
                            ...
                            <div class="checkbox">
                                <React.Fragment>{
                                    initialState.condicionesMedicas.map(item => (
                                        <label>
                                            <input type="checkbox" name="condicionesMedicas" value={item.value} onChange={onChange(item)} />
                                            {item.value}
                                            <br/>
                                        </label>
                                    ))
                            ...
                            <div class="checkbox">
                                <React.Fragment>{
                                    initialState.situacionesPandemia.map(item => (
                                        <label>
                                            <input type="checkbox" name="situacionesPandemia" value={item.value} onChange={onChange(item)} />
                                            {item.value}
                                            <br/>
                                        </label>
                                    ))
                            ...
                            <div class="radio">
                                <React.Fragment>{
                                    initialState.actFisica.map(item => (
                                        <label>
                                            <input type="radio" name="actFisica" value={item.value} onChange={onChangeValue} required />
                                            {item.value}
                                            <br/>
                                        </label>
                                    ))
